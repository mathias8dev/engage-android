...
```kotlin
dependencies {
    implementation("com.github.mathias8dev.engage-android:engage-android-core:2.2.1")
    implementation("com.github.mathias8dev.engage-android:engage-android-push-fcm:2.2.1")
    implementation("com.github.mathias8dev.engage-android:engage-android-in-app:2.2.1")
    implementation("com.github.mathias8dev.engage-android:engage-android-message-center:2.2.1")
    implementation("com.github.mathias8dev.engage-android:engage-android-message-center-divkit:2.2.1")
}
```
